            ...
            <div className="flex-1 space-y-6 pb-4">
                ...
                {messages.length === 0 && !error && (
                    ...
                    useEffect(() => {
                        if (messages.length === 0 && !isLoading && !error) {
                            ...
                            // Since we can't easily hide messages in useChat without custom logic,
                            // we will let the user "see" their own prompt or just use setMessages if we want a cleaner start.
                            // BETTER: Just append a system-like prompt from the user's perspective.
                            // "Coach, I'm here. Please start the session."
                            append({
                                role: 'user',
                ...
                <div className="max-w-4xl mx-auto flex flex-col min-h-[500px]">
                    ...
                    <div className="text-center pb-24">
                        <p className="text-[10px] text-gray-400">v1.5 - Auto-Start & Proactive</p>
                    </div>
                </div>
                );
}
